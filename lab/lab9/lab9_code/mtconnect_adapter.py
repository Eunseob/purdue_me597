...
class Adapter(ThreadingMixIn, TCPServer):
    ...
    def heartbeat(self, client):
        try:
            ...
            print("Exception in heartbeat thread: " + str(ex))
    ...
    def remove_client(self, client_address):
        ...
        try:
            ...
            print("Exception closing socket for " + str(client_address)+" : "+str(ex))
        finally:
            self._lock.release()
